                    ...
                    {passwordChecks.map((check) => (
                      <div
                        ...
                        className={`flex items-center gap-1.5 text-xs transition-colors duration-200 ${
                          check.pass ? "text-emerald-400" : "text-[var(--muted-foreground)]"
                        }`}
                      >
                        {check.pass ? (
    ...
    <Suspense fallback={
      <main className="flex min-h-dvh items-center justify-center bg-[var(--background)]">
        <div className="flex items-center gap-3 text-[var(--muted-foreground)]">
          <span className="h-5 w-5 animate-spin rounded-full border-2 border-[var(--muted-foreground)]/30 border-t-[var(--foreground)]" />
