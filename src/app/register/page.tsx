...
// GitHub icon SVG inline — lucide-react não tem ícone oficial do GitHub
        ...
        <GlassCard className="p-6">
          <div className="relative z-[1]">
            ...
            <div className="space-y-3">
              ...
              >
                <svg className="h-5 w-5 relative z-[1] shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <svg className="h-5 w-5 relative z-[1] shrink-0" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
